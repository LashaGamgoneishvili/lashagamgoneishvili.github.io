...
import jano from "../kniaz.jpg";
import janoqr from "./kniaz-qr.png";
  ...
  return (
    <>
        ...
        <div className="about-about-me">
          ...
          <div className="about-icons-container">
            ...
            <a
              ...
              href="https://www.instagram.com/kno088/"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <div className="musical-notes icon">
              <a
                href="https://www.youtube.com/watch?v=IpNFxofgQ6c"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div class={popup}>
        ...
        <p style={{ cursor: "pointer" }}>+49 177 4024804</p>
      </div>
      <div class={qr}>
        <button class="button" onClick={handleClose}>
          &#10005;
