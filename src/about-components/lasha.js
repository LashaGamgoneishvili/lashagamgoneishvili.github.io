...
import lashaqr from "./lasha-qr.png";
import maillqr from "./lasha-mail-qr.png";
import {
  AiFillPhone,
  AiFillPicture,
  AiFillMail,
    ...
    <>
      <main className="about-container">
        <div className="about-img-container">
          <img src={lasha} alt="Lasha's" />
        </div>
        <div className="about-about-me">
          <h1>Lasha Gamgoneishvili</h1>
          <p>
          ...
          <div className="about-icons-container">
            ...
            <div className="musical-notes icon">
              <a
                href="https://www.youtube.com/watch?v=8pS6yYs0SFQ"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div class={popup}>
        ...
        <p style={{ cursor: "pointer" }}>+49 177 5053667</p>
      </div>
      <div class={qr}>
        <button class="button" onClick={handleClose}>
          &#10005;
        </button>
        <img src={lashaqr} alt="Qr-Code" />
      </div>
      <div class={mail}>
        <button class="button" onClick={handleClose}>
          &#10005;
        ...
        <div className="inside-mailbox">
          <h1>gamgoneishvili8@gmail.com</h1>
