...
import tokoqr from "./toko-qr.png";
    ...
    <>
      <main className="about-container">
        <div className="about-img-container">
          <img src={toko} alt="Lasha's" />
        </div>
        <div className="about-about-me">
          <h1>Torkine(Toko) Jikia</h1>
          <p>
          ...
          <div className="about-icons-container">
            ...
            <a
              ...
              href="https://www.instagram.com/tornikej918/?igshid=MzRlODBiNWFlZA%3D%3D&fbclid=IwAR0C5Nl6oupWqrOs4n6qyeEDFvogCbunyqQ0nkpk8vfishXhgOCp5yINOS8"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <div className="musical-notes icon">
              <a
                href="https://www.youtube.com/watch?v=wYzUQpIkZ1g"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div class={popup}>
        ...
        <p style={{ cursor: "pointer" }}>+49 177 5053660</p>
      </div>
      <div class={qr}>
        <button class="button" onClick={handleClose}>
          &#10005;
        </button>
        <img src={tokoqr} alt="Qr-Code" />
      </div>
