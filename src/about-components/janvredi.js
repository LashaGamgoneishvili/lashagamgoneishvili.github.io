...
import janoqr from "./jano-qr.png";
    ...
    <>
      <main className="about-container">
        <div className="about-img-container">
          <img src={jano} alt="Lasha's" />
        </div>
        <div className="about-about-me">
          <h1>Janverdi(Jano) Janelidze</h1>
          <p>
          ...
          <div className="about-icons-container">
            ...
            <a
              className="about-icon"
              href="https://twitter.com/JanverdiJ13?fbclid=IwAR0hQIqppuzFQXzYYOfGg0VfFy6belMA_cOeEJop1BCsImrUjTBzherynSs"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaTwitter
            ...
            <div className="musical-notes icon">
              <a
                href="https://www.youtube.com/watch?v=e2vj6ma-854"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div class={popup}>
        ...
        <p style={{ cursor: "pointer" }}>+49 177 4024745</p>
      </div>
      <div class={qr}>
        <button class="button" onClick={handleClose}>
          &#10005;
        </button>
        <img src={janoqr} alt="Qr-Code" />
      </div>
      ...
      <div class={mail}>
        ...
        <div className="inside-mailbox">
          <h1>janverdijanelidze@gmail.com</h1>
